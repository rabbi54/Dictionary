...
def seedData(apps, schema_editor):
    ...
    for word in data:
        ...
        # collision happened
        while word_list.objects.filter(p_hash_indx=p_hash, s_hash_indx=s_hash) and not first_time:  # while the second hash isn't unique repeat
            flag_collision = True
            m = m * m
